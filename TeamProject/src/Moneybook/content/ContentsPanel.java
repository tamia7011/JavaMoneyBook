...
public class ContentsPanel extends JPanel {
	...
	private ContentsPanel() {
		...
		table.setModel(new DefaultTableModel(new Object[][] { { "id", "type", "name", "price", }, },
				new String[] { "id", "type", "name", "price", }));
		...
		MileageBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, "Successfully acculated your mileage!!", "show information",
