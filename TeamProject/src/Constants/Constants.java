...
public class Constants {
	...
	// Fixed = expenses you can't control, Flexible = necessary for day-to-living
	// but you can control the amount,
	// Discretionary = not essential for day-to-living and you can control the
	// amount
	public static enum expenseType {
		Fixed, Flexible, Waste, Default
	}
